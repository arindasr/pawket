import { CalendarDays, MapPin, Clock3, CheckCircle2 } from 'lucide-react'
        ...
        {days.map(dateKey => {
          ...
          return (
            <button
              ...
              className={`w-full text-left flex items-center justify-between px-4 py-3.5 rounded-2xl border-2 transition-colors ${
                isCurrent
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#9e8e7e] mt-0.5">
